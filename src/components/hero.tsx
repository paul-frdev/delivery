  ...
  return (
    <section className='bg-hero bg-no-repeat bg-left-top min-h-[800px] lg:min-h-[950px] lg:mb-80'>
      <Container
        ...
        initial="initial"
        animate="animate"
        className='relative max-w-[1200px] min-h-[800px] lg:min-h-[950px]'
      >
        <motion.h1 variants={fadeInDown} className='h1 max-w-[740px] text-white pt-[12rem] mb-[60px]'>Your awesome traffic permit consultant.</motion.h1>
        <Button icon={<CgArrowLongRight />} variants={fadeInDown} whileHover={{ scale: 1.05 }} className='btn'>Get Started</Button>
