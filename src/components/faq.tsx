...
export const Faq = () => {
  ...
  return (
    <section className='min-h-[1150px] lg:bg-faq bg-no-repeat bg-right-top lg:pt-40 lg:pb-24 mb--[30px] lg:mb-[60px]'>
      <Container>
        <motion.div variants={staggerTextContainer} initial="initial" whileInView={'animate'} viewport={{ once: false, amount: 0.6 }} className='relative flex flex-col lg:flex-row justify-center lg:justify-start items-center pt-8 pb-16 lg:pt-16 lg:pb-32'>
        ...
        {!showMore && (
          <motion.div variants={fadeInRight} className='w-full mt-4'>
            <Button onClick={handleShowMoreClick} className='m-auto'>Show More</Button>
          </motion.div>
        )}
      </Container>
    </section>
